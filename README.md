...
- モデル: `SD1.5\realisticVisionV60B1_v51VAE`（sprites 既定。滑らかな fine-tune の方が ControlNet のポーズ追従が安定し、ピクセル化は pixelate 側で行う）, `control_v11p_sd15_openpose_fp16`, `control_v11f1p_sd15_depth_fp16`, `ip-adapter-plus_sd15` + `CLIP-ViT-H-14`, BiRefNet ToonOut（comfyui-rmbg が自動 DL）, Qwen-Image-Edit 2511 (GGUF Q5) + Lightning LoRA
