...
export const MOTIONS: Motion[] = [
  ...
  },
  {
    ...
    source: "quaternius",
    fbx: "UAL1_Standard.fbx",
    action: "Pistol_Aim_Neutral",
    frames: 4,
    loop: true,
    fps: 4,
    prompt: "aiming a handgun with both hands",
  },
  {
    id: "roll",
    source: "quaternius",
    ...
    loop: false,
    fps: 12,
    prompt: "forward roll, tumbling on the ground",
  },
  {
    id: "attack_a",
    source: "quaternius",
    fbx: "UAL2_Standard.fbx",
    action: "Sword_Regular_A",
    frames: 6,
    loop: false,
    fps: 12,
    prompt: "swinging a sword",
  },
  {
    id: "attack_b",
    source: "quaternius",
